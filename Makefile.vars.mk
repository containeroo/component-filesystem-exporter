...
COMPONENT_NAME ?= filesystem-exporter
...
ifeq ($(instance),archive)
component_alias = archive
endif

ifneq ($(component_alias),)
commodore_args += -a $(component_alias)
endif
...
instance ?= defaults
test_instances = tests/defaults.yml tests/dashboard.yml tests/archive.yml tests/openshift-nfs.yml tests/report-child-dirs.yml tests/collector-alerts.yml
